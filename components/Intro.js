...
export const Intro = ({ title, description, subdescription, image, buttons }) => {
	return (
			...
			<div className="container">
				<div className=" row align-items-center">
					<div className="col-sm-6 align-items-start">
						...
						<p className="fw-bold fs-5">{subdescription}</p>
...
export const About = ({ title, description, buttons, skills }) => {
	return (
		<div id="about" className="bg-white py-5 px-5 fs-5">
			<div className="container">
